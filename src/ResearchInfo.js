...
const ResearchInfo = (props) => {
    ...
    return (
        <div className='pt-5'>
            <div className='font-medium text-2xl text-800'>{props.data.name} Price and Market Data</div>
            ...
            <div className='font-medium text-2xl mt-2 text-800'>What was the highest price for {props.data.name}?</div>
            ...
            <div className='font-medium text-2xl mt-2 text-800'>What was the lowest price for {props.data.name}?</div>
            ...
            <div className='font-medium text-2xl mt-2 text-800'>What is {props.data.name}? </div>
            <div>{tokenInfo}</div>
