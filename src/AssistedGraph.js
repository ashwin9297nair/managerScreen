...
export class AssistedGraph extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className='grid pl-2 text-lg'>
          <div className='col-6'>
            <div id='time' className='mr-1'>Current Price</div>
            <div className='flex align-items-center'>
              <div className='font-bold text-xl' id='value'>${finalvalue}</div>
              <div id='percentchange' className='ml-1 text-sm'></div>
            </div>
          </div>
          <div className='col-6'>
            <div className='align-right'>
              <SelectButton className='font-light' value={this.state.value2} options={this.paymentOptions} onChange={(e) => this.setState({ value2: e.value })} optionLabel="name" />
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div onMouseOut={mouseout} >
            <Chart style={{ height: '350px' }} className='text-3xl' type="line" data={this.basicData[this.state.value2]} options={basicOptions} />
          </div>
        </div>
      </div>
    )
