        ...
        return (
            <div className="card-rs">
                ...
                <div className="card--data ">
                    ...
                    <p className="card--description">{descrp} <a className="card--sourceLink card--source" href={"https://" + source.slice(0, source.indexOf("/"))} target="_blank" rel="noreferrer" > See more... </a> </p>
